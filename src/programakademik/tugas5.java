...
import java.util.Scanner; //import scanner untuk imputannya
public class tugas5 {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in); //object scanner baru

        String nama, nim, jenisKelamin, alamat, nope, pos,  def="Masukan "; //variabel

        System.out.println("|     BIODATA MAHASISWA UNISKA       |");
        System.out.println("===========================================");
        ...
        nope = input.nextLine();
        System.out.println(def + "program studi\t: ");
        pos = input.nextLine();
        ...
        System.out.println("| Program Studi\t: " + pos);
        System.out.println("+------------------------------------------+");
    }
}
